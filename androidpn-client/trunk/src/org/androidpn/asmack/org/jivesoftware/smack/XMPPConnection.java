...
public class XMPPConnection extends Connection {
    ...
    private void initReaderAndWriter() throws XMPPException {
        try {
            if (!usingCompression) {
                ...
                try {
                    Class<?> zoClass = Class.forName("org.androidpn.asmack.com.jcraft.jzlib.ZOutputStream");
                    ...
                    Class<?> ziClass = Class.forName("org.androidpn.asmack.com.jcraft.jzlib.ZInputStream");
    ...
    private boolean useCompression() {
        ...
        try {
            Class.forName("org.androidpn.asmack.com.jcraft.jzlib.ZOutputStream");
        }
